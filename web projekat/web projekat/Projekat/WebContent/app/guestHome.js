Vue.component("guestHome", {
	...
	<div class="topnav">
			<div style="padding-top: 25px; padding-right: 10px; float: left;">
				<button style="color:blue" v-on:click="homePage()"> Povratak na glavnu stranicu! </button>
			</div>
		<br><br><br>
		<div style="background-color: white">
			<h2 style="padding-left: 40px; padding-top: 5px">Dobro došli!</h2>
		</div>
	</div>
  ...
  <select v-on:change="onChange(filterRestaurantStatus, filterRestaurantType, searchName, searchLocation, searchType, searchGrade)" v-model="searchGrade" style = "width: 120px; height: 30px">
	...
	<table class="content-table" >
  	...
  	<tbody>
   	<tr v-for="i in restaurants" >
			...
			<td > <button style="color:blue" v-on:click="goToRestaurant(i.id)"> Pregledaj! </button> </td>
		</tr>
  	</tbody>
	</table>
	...
	methods:
	{
		...
		goToRestaurant: function(id) {
				router.push(`/guestRestaurantHome/${id}`)
		},
